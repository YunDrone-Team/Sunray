...
int main(int argc, char **argv)
{
    ...
    // 初始化ROS节点
    ros::init(argc, argv, "simple_obstacle_avoidance_d435i");
    ros::NodeHandle nh("~");
    ...
    ros::Subscriber depth_image_sub = nh.subscribe<sensor_msgs::Image>("/camera/depth/image_rect_raw", 1, depth_image_cb);
