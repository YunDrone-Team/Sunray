...
declare -A TMUX_CONFIG=(
    ["main"]="
        ...
        sleep 8 && roslaunch sunray_uav_control external_fusion.launch external_source:=4 position_topic:=/baton/stereo3/odometry enable_rviz:=false use_vision_pose:=false tilted:=true uav_id:=${UAV_ID}
