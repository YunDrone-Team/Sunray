...
namespace gazebo
{
    ...
    void LivoxPointsPlugin::Load(gazebo::sensors::SensorPtr _parent, sdf::ElementPtr sdf)
    {
        ...
        if (sdf->HasElement("frameName"))
        {
            ...
            if (frame_name.empty())
            {
                frame_name = "livox_points";
            }
        }
        else
        {
            ROS_INFO_STREAM("frameName is empty!");
            frame_name = "livox_points";
        }
        ...
        if (sdf->HasElement("robotNamespace"))
        {
            ...
            if (robot_namespace.empty())
            {
                ...
                {
                    robot_namespace = values[1];
                    frame_name = values[1] + "/" + frame_name;
                }
        ...
        {
            ROS_INFO_STREAM("robotNamespace is empty!");
        }
        ...
        curr_scan_topic = "/" + robot_namespace + "/" + curr_scan_topic;
