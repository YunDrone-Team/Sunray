...
--tab -e 'bash -c "sleep 2.0; roslaunch sunray_simulator sunray_sim_tag_car.launch; exec bash"' \
...
--tab -e 'bash -c "sleep 3.0; roslaunch sunray_tutorial follow_car_xyvelzposyawbody.launch; exec bash"' \
