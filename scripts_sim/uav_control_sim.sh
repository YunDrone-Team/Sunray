#!/bin/bash
# 脚本：无人机控制测试脚本
gnome-terminal --window -e 'bash -c "roslaunch sunray_simulator sunray_sim_1uav.launch vehicle:=sunray150; exec bash"' \
--tab -e 'bash -c "sleep 10.0; roslaunch sunray_uav_control external_fusion.launch external_source:=2; exec bash"' \
